...
public class SportsButtonActivity extends AppCompatActivity {

    public static final String TAG = SportsButtonActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if (isNetworkAvailable()) {
            ...
            Toast.makeText(this, R.string.network_unavilable_message,
                    Toast.LENGTH_LONG).show();
        }

        Log.d(TAG, "SportsButton UI is running!");
    }
